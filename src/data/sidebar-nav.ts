...
export const sidebarSections: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { title: "Appel", titleKey: "nav.absences", icon: UserCheck, url: "/dashboard/absences/feuilles", roles: ["SUPER_ADMIN", "ADMIN", "DIRECTEUR", "ENSEIGNANT"] },
  ...
  /* Quiz section — temporarily hidden
  {
    label: "Quiz",
    labelKey: "nav.quiz",
    icon: FileQuestion,

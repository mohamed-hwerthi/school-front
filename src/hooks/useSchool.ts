...
function toSchoolInfo(dto: SchoolSettingsDTO): SchoolInfo {
  return {
    ...
    logo: dto.logo ?? "",
    adresse: dto.adresse ?? "",
    adresseAr: dto.adresseAr ?? "",
    telephone: dto.telephone ?? "",
    email: dto.email ?? "",
    siteWeb: dto.siteWeb ?? "",
    directeur: dto.directeurName ?? "",
    directeurAr: dto.directeurNameAr ?? "",
    delegationRegionale: dto.delegationRegionale ?? "",
    delegationRegionaleAr: dto.delegationRegionaleAr ?? "",
...
function toDTO(data: Partial<SchoolInfo>, current: SchoolSettingsDTO): SchoolSettingsDTO {
  return {
    ...
    adresseAr: data.adresseAr ?? current.adresseAr,
    ...
    directeurNameAr: data.directeurAr ?? current.directeurNameAr,
    delegationRegionale: data.delegationRegionale ?? current.delegationRegionale,
    delegationRegionaleAr: data.delegationRegionaleAr ?? current.delegationRegionaleAr,
...
const DEFAULT_DTO: SchoolSettingsDTO = {
  ...
  delegationRegionale: null,
  delegationRegionaleAr: null,
  logo: null,
  email: null,
  siteWeb: null,
  anneeCreation: null,
